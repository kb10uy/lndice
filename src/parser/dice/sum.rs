...
mod test {
    ...
    fn sum_dice_parses_basic() {
        ...
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 1, faces: 6 },
                pick: None
            })
        );
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 2, faces: 10 },
                pick: None
            })
        );
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 10, faces: 4 },
                pick: None
            })
        );
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 20, faces: 20 },
                pick: None
            })
        );
    }
    ...
    fn sum_dice_parses_pick() {
        ...
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 5, faces: 6 },
        ...
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 3, faces: 4 },
        ...
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 5, faces: 12 },
        ...
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 3, faces: 6 },
        ...
        assert_eq!(
            ...
            Ok(SumDice {
                element: DiceElement { rolls: 4, faces: 8 },
